...
* a [Dashboard](/docs/platform_introduction/dashboard.md) that provides an overview of a user's projects and permits to launch the creation of a new project.
