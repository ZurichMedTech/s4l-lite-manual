...
- _**Quick Start**_: A short **Quick Start** guide, which is also displayed the first time the Sim4Life:web *lite* is accessed
...
- _**Logout**_: Logging out from the Sim4Life:web *lite* 
