...
The user can access more functionality such as **_Project data_**, **_Sharing_**, **_Duplicate_** and **_More options_** through the ellipsis (1.) menu button.
If Services within a Plan need updating, the small circular arrow sign will appear in the bottom right corner (2.) of the Plan on the **Dashboard**. Clicking this icon will bring you directly to the update menu where you see the current and newest available versions of each Service and where you can update them either individually or all together.
